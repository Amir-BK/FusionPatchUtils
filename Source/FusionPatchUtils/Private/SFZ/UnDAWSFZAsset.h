...
DECLARE_LOG_CATEGORY_EXTERN(FK_SFZ_Logs, Verbose, All);
...
class FUSIONPATCHUTILS_API USFZRegion : public UObject
{
	GENERATED_BODY()
...
UCLASS()
class FUSIONPATCHUTILS_API UFK_Region_Runtime_Performance_Data : public UObject //, public IAudioProxyDataFactory
{
	GENERATED_BODY()
public:
...
//class FUSIONPATCHUTILS_API FFK_SFZ_Region_Performance_Proxy : public Audio::TProxyData<FFK_SFZ_Region_Performance_Proxy>
//{
//public:
...
class FUSIONPATCHUTILS_API USFZGroupedRegions : public UObject //, public IAudioProxyDataFactory
{
	GENERATED_BODY()
...
class FUSIONPATCHUTILS_API UFKSFZAsset : public UObject
{
	GENERATED_BODY()
